...

{
    ...
    "validation_dataset_readers": READERS(TRAIN_LANGS, false),
    // "random_seed": 531,
    // "numpy_seed": 531,
    "vocabulary": {
        "type": "from_files",
    ...
    "model": {
        ...
        "arc_representation_dim": HIDDEN_SIZE * NUM_DIRS,
        "tag_representation_dim": HIDDEN_SIZE * NUM_DIRS,
        "dropout": 0.0,
    ...
    "validation_data_paths": {
        [lang]: DATA_PATH(lang, "dev") for lang in TRAIN_LANGS
    },
    "trainer": {
        "type": "meta",
        "cuda_device": 0,
