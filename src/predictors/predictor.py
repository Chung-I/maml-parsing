"""
The main UD predictor to output conllu files
"""
...
@Predictor.register("ud_predictor")
class UDPredictor(Predictor):
    """
    Predictor for a UD model that takes in a sentence and returns
