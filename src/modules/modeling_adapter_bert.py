...
class Adapter(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.dense1 = nn.Linear(config.hidden_size, config.adapter_size)
        self.dense2 = nn.Linear(config.adapter_size, config.hidden_size)
    ...
    def forward(self, hidden_states):
        bottlenecked_states = self.dense1(hidden_states)
        bottlenecked_states = self.intermediate_act_fn(bottlenecked_states)
        bottlenecked_states = self.dense2(bottlenecked_states)
        return bottlenecked_states + hidden_states
