...
from src.training import util as training_util
...
class MetaTrainerPieces(NamedTuple):
    ...
    test_datasets: Dict[str, Iterable[Instance]]
    ...
    def create_or_extend_vocab(
        ...
        datasets = {key: dataset for key, dataset in datasets.items()
            if key in datasets_for_vocab_creation}
        flat_datasets = training_util.as_flat_dict(datasets)
        instance_generator = (instance for key, dataset in flat_datasets.items()
